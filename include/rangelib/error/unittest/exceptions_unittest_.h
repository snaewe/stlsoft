...
#if !defined(RANGELIB_INCL_RANGELIB_ERROR_HPP_EXCEPTIONS)
# error This file cannot be directly included, and should only be included within rangelib/error/exceptions.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_rangelib_exceptions(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "RangeLib", "error/exceptions", __FILE__);
