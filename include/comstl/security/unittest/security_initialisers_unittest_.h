...
#if !defined(COMSTL_INCL_COMSTL_SECURITY_HPP_SECURITY_INITIALISERS)
# error This file cannot be directly included, and should only be included within comstl/security/security_initialisers.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_comstl_security_initialisers(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "COMSTL", "security/security_initialisers", __FILE__);
