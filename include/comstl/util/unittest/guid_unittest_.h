...
#if !defined(COMSTL_INCL_COMSTL_UTIL_HPP_COMSTL_GUID)
# error This file cannot be directly included, and should only be included within comstl/util/guid.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_comstl_guid(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "COMSTL", "util/guid", __FILE__);
