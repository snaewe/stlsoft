...
#if !defined(COMSTL_INCL_COMSTL_MEMORY_HPP_TASK_ALLOCATOR)
# error This file cannot be directly included, and should only be included within comstl/memory/task_allocator.hpp
