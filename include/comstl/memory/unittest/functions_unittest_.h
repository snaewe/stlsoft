...
#if !defined(COMSTL_INCL_COMSTL_MEMORY_H_FUNCTIONS)
# error This file cannot be directly included, and should only be included within comstl/memory/functions.h
