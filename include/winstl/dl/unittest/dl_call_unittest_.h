...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_dl_dl_call(unittest_reporter *r)
		{
			using stlsoft::unittest::unittest_initialiser;

			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "WinSTL", "dl/dl_call", __FILE__);
		...
		unittest_registrar	  unittest_winstl_dl_dl_call(test_winstl_dl_dl_call);
	} // anonymous namespace
