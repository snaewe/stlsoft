...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_dl_module(unittest_reporter *r)
		{
			using stlsoft::unittest::unittest_initialiser;

			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "WinSTL", "dl/module", __FILE__);
		...
		unittest_registrar	  unittest_winstl_dl_module(test_winstl_dl_module);
	} // anonymous namespace
