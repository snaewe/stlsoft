...
#if !defined(WINSTL_INCL_WINSTL_SYNCH_HPP_THREAD_MUTEX)
# error This file cannot be directly included, and should only be included within winstl/synch/thread_mutex.hpp
