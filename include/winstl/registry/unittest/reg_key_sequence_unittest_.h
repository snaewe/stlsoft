...
#if !defined(WINSTL_INCL_WINSTL_REGISTRY_HPP_REG_KEY_SEQUENCE)
# error This file cannot be directly included, and should only be included within winstl/registry/reg_key_sequence.hpp
