...
#if !defined(WINSTL_INCL_WINSTL_TIME_H_COMPARISON_FUNCTIONS)
# error This file cannot be directly included, and should only be included within winstl/time/comparison_functions.h
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_time_comparison_functions(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "WinSTL", "time/time_comparison_functions", __FILE__);
