...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_memory_processheap_allocator(unittest_reporter *r)
		{
			using stlsoft::unittest::unittest_initialiser;

			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "WinSTL", "memory/processheap_allocator", __FILE__);
		...
		unittest_registrar	  unittest_winstl_memory_processheap_allocator(test_winstl_memory_processheap_allocator);
	} // anonymous namespace
