...
#if !defined(WINSTL_INCL_WINSTL_CONTROLS_HPP_COMBOBOX_SEQUENCE)
# error This file cannot be directly included, and should only be included within winstl/controls/combobox_sequence.hpp
#endif /* !WINSTL_INCL_WINSTL_HPP_CONTROLS_COMBOBOX_SEQUENCE */
