...
#if !defined(WINSTL_INCL_WINSTL_WINDOW_UTIL_HPP_IDENT_)
# error This file cannot be directly included, and should only be included within winstl/windows/util/ident_.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_windows_ident(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "WinSTL", "window/util/ident_", __FILE__);
