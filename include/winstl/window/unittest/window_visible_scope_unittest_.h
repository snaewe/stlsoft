...
#if !defined(WINSTL_INCL_WINSTL_WINDOW_HPP_WINDOW_VISIBLE_SCOPE)
# error This file cannot be directly included, and should only be included within winstl/window/window_visible_scope.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_window_visible_scope(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "WinSTL", "window/window_visible_scope", __FILE__);
