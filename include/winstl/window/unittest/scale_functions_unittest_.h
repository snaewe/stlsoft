...
#if !defined(WINSTL_INCL_WINSTL_WINDOW_H_SCALE_FUNCTIONS)
# error This file cannot be directly included, and should only be included within winstl/window/scale_functions.h
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_scale_functions(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "WinSTL", "window/scale_functions", __FILE__);
