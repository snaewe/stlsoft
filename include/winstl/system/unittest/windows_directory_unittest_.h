...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_system_windows_directory(unittest_reporter *r)
		{
			using stlsoft::unittest::unittest_initialiser;

			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "WinSTL", "system/windows_directory", __FILE__);
		...
		unittest_registrar	  unittest_winstl_system_windows_directory(test_winstl_system_windows_directory);
	} // anonymous namespace
