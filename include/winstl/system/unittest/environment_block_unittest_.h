...
#if !defined(WINSTL_INCL_WINSTL_SYSTEM_HPP_ENVIRONMENT_BLOCK)
# error This file cannot be directly included, and should only be included within winstl/system/environment_block.hpp
