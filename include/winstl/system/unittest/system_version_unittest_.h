...
#if !defined(WINSTL_INCL_WINSTL_SYSTEM_HPP_SYSTEM_VERSION)
# error This file cannot be directly included, and should only be included within winstl/system/system_version.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_winstl_system_system_version(unittest_reporter *r)
		{
			using stlsoft::unittest::unittest_initialiser;

			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "WinSTL", "system/system_version", __FILE__);
		...
		unittest_registrar	  unittest_winstl_system_system_version(test_winstl_system_system_version);
	} // anonymous namespace
