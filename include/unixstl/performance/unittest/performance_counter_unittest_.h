...
namespace unittest
{
	namespace
	{
		ss_bool_t test_unixstl_performance_performance_counter(unittest_reporter *r)
		{
			using stlsoft::unittest::unittest_initialiser;

			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "UNIXSTL", "performance/performance_counter", __FILE__);
		...
		unittest_registrar	  unittest_unixstl_performance_performance_counter(test_unixstl_performance_performance_counter);
	} // anonymous namespace
