...
#if !defined(STLSOFT_INCL_STLSOFT_SHIMS_ACCESS_STRING_STD_H_C_STRING)
# error This file cannot be directly included, and should only be included within stlsoft/shims/access/string/std/c_string.h
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_stlsoft_shims_access_string_std_c_string_a(unittest_reporter *r)
		{
		...
		ss_bool_t test_stlsoft_shims_access_string_std_c_string_w(unittest_reporter *r)
		{
			ss_bool_t			bSuccess	=	true;
		...
		ss_bool_t test_stlsoft_shims_access_string_std_c_string(unittest_reporter *r)
		{
			ss_bool_t				bSuccess	=	true;

			unittest_initialiser	init(r, "STLSoft", "shims/access/string/std/c_string", __FILE__);

			if(!test_stlsoft_shims_access_string_std_c_string_a(r))
			{
				bSuccess = false;
			}

			if(!test_stlsoft_shims_access_string_std_c_string_w(r))
			{
				bSuccess = false;
			}
		...
		unittest_registrar	  unittest_stlsoft_shims_access_string_std_c_string(test_stlsoft_shims_access_string_std_c_string);
	} // anonymous namespace
