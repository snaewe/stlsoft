...
#if !defined(STLSOFT_INCL_STLSOFT_ERROR_HPP_ITERATION_INTERRUPTION)
# error This file cannot be directly included, and should only be included within stlsoft/error/iteration_interruption.hpp
