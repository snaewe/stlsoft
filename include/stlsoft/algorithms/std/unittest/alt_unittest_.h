...
#if !defined(STLSOFT_INCL_STLSOFT_ALGORITHMS_STD_HPP_ALT)
# error This file cannot be directly included, and should only be included within stlsoft/algorithms/std/alt.hpp
...
namespace unittest
{
	namespace
	{
		...
		ss_bool_t test_stlsoft_std_alt_algorithms(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "STLSoft", "std_alt_algorithms", __FILE__);
		...
		unittest_registrar	  unittest_stlsoft_std_alt_algorithms(test_stlsoft_std_alt_algorithms);
	} // anonymous namespace
