...
#if !defined(STLSOFT_INCL_STLSOFT_ALGORITHMS_HPP_DEBUG)
# error This file cannot be directly included, and should only be included within stlsoft/algorithms/debug.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_stlsoft_debug_algorithms(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "STLSoft", "debug_algorithms", __FILE__);
		...
		unittest_registrar	  unittest_stlsoft_debug_algorithms(test_stlsoft_debug_algorithms);
	} // anonymous namespace
