...
#if !defined(ACESTL_INCL_ACESTL_REACTOR_HPP_CUSTOM_EVENT_HANDLER)
# error This file cannot be directly included, and should only be included within acestl/reactor/custom_event_handler.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_acestl_custom_event_handler(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "ACESTL", "reactor/custom_event_handler", __FILE__);
