...
#if !defined(ACESTL_INCL_ACESTL_COLLECTIONS_HPP_MESSAGE_QUEUE_SEQUENCE)
# error This file cannot be directly included, and should only be included within acestl/collections/message_queue_sequence.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_acestl_message_queue_sequence(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "ACESTL", "collections/message_queue_sequence", __FILE__);
