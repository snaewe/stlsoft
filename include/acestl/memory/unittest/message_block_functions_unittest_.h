...
#if !defined(ACESTL_INCL_ACESTL_MEMORY_HPP_MESSAGE_BLOCK_FUNCTIONS)
# error This file cannot be directly included, and should only be included within acestl/memory/message_block_functions.hpp
...
namespace unittest
{
	namespace
	{
		ss_bool_t test_acestl_message_block_functions(unittest_reporter *r)
		{
			...
			unittest_initialiser	init(r, "ACESTL", "memory/message_block_functions", __FILE__);
